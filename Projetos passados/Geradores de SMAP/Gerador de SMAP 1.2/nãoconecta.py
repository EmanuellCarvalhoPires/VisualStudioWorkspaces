def main():
    print("NÃO CONECTA - Para todas as perguntas caso não seja necessário aquela informação específica, apenas digite deixe em branco\n=============================================")
    ...
    if teste_outro_aparelho.lower() == "sim":
        ...
        nao = "*"
    QOS = str(input("Informar QOS caso necessário: "))
